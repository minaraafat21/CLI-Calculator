...
from python.cli_calculator import calculate

# Tests for the calculate function
@patch('python.cli_calculator.add')
...
@patch('python.cli_calculator.subtract')
...
@patch('python.cli_calculator.multiply')
...
@patch('python.cli_calculator.divide')
